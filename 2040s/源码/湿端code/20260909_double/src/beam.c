...
/**************************************UIO结构体**************************************/
UIO_CONFIG_PARAMETER uio_iq_mem_a = { .physical_addr = (unsigned int *)DDR_SHARE_MEM_BASEADDR_IQ_A ,.uiod = "/dev/uio0", .sysfs_path_file = "/sys/class/uio/uio0/maps/map0/size"};
UIO_CONFIG_PARAMETER uio_iq_mem_b = { .physical_addr = (unsigned int *)DDR_SHARE_MEM_BASEADDR_IQ_B ,.uiod = "/dev/uio1", .sysfs_path_file = "/sys/class/uio/uio1/maps/map0/size"};
UIO_CONFIG_PARAMETER data_head_mem_a = { .physical_addr = (unsigned int *)DDR_DATA_HEAD_BASEADDR_A ,.uiod = "/dev/uio2", .sysfs_path_file = "/sys/class/uio/uio2/maps/map0/size" };
UIO_CONFIG_PARAMETER data_head_mem_b = { .physical_addr = (unsigned int *)DDR_DATA_HEAD_BASEADDR_B ,.uiod = "/dev/uio3", .sysfs_path_file = "/sys/class/uio/uio3/maps/map0/size" };
UIO_CONFIG_PARAMETER sensor_mem_0 = { .physical_addr = (unsigned int *)SENSOR_SHARE_MEM_BASEADDR_0 ,.uiod = "/dev/uio4", .sysfs_path_file = "/sys/class/uio/uio4/maps/map0/size" };
UIO_CONFIG_PARAMETER sensor_mem_1 = { .physical_addr = (unsigned int *)SENSOR_SHARE_MEM_BASEADDR_8 ,.uiod = "/dev/uio5", .sysfs_path_file = "/sys/class/uio/uio5/maps/map0/size" };
UIO_CONFIG_PARAMETER original_mem = { .physical_addr = (unsigned int *)DDR_SHARE_MEM_BASEADDR_ORIGINAL ,.uiod = "/dev/uio6", .sysfs_path_file = "/sys/class/uio/uio6/maps/map0/size" };
UIO_CONFIG_PARAMETER tvg_register_mem = { .physical_addr = (unsigned int *)DDR_TVG_BASEADDR ,.uiod = "/dev/uio7", .sysfs_path_file = "/sys/class/uio/uio7/maps/map0/size" };
UIO_CONFIG_PARAMETER fpga_register_mem = { .physical_addr = (unsigned int *)DDR_FPGA_REGISTER_BASEADDR ,.uiod = "/dev/uio8", .sysfs_path_file = "/sys/class/uio/uio8/maps/map0/size" };
...
FPGA_DDR_FIRST fpga_ddr_frame_first_1;//中断接收到的ddr数据头
FPGA_DDR_FIRST *ptr_fpga_frame_first_a=&fpga_ddr_frame_first_1;
FPGA_DDR_FIRST fpga_ddr_frame_first_2;//中断接收到的ddr数据头
FPGA_DDR_FIRST *ptr_fpga_frame_first_b=&fpga_ddr_frame_first_2;
