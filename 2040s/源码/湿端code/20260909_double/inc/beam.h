...
/*********************************DDR memory UIO1*****************************/
#define   DDR_SHARE_MEM_BASEADDR_IQ_A               0x20000000//DDR基地址_IQ     48M
#define   DDR_SHARE_MEM_BASEADDR_IQ_B               0x23000000//DDR基地址_IQ     48M 
#define   DDR_DATA_HEAD_BASEADDR_A                  0x27000000//DDR基地址_数据头  4096
#define   DDR_DATA_HEAD_BASEADDR_B                  0x27001000//DDR基地址_数据头  4096
#define   SENSOR_SHARE_MEM_BASEADDR_0               0x2F000000//传感器基地址----buffer0 5M
#define   SENSOR_SHARE_MEM_BASEADDR_8               0x2F800000//传感器基地址----buffer1 5M
#define   DDR_SHARE_MEM_BASEADDR_ORIGINAL           0x30000000//DDR基地址_原始      128M
#define   DDR_TVG_BASEADDR                          0x40000000//DDR基地址_TVG    8K
#define   DDR_FPGA_REGISTER_BASEADDR                0x43C00000//DDR基地址_FPGA寄存器 4K
...
typedef struct 
{
   ...
   unsigned int  pwm_ip[12];//PWM初始相位寄存器 
...
typedef struct 
{
    unsigned int  wstatus;//FPGA工作状态寄存器 高16bit：发射板版本 低16bit：DA调压值
    unsigned int  date;//FPGA版本日期 高 16bit:发射板温度 低 16bit:电容电压值.
...
{ 
    ...
    unsigned int SonarDataLength;//4 Byte 声学数据长度
...
extern UIO_CONFIG_PARAMETER uio_iq_mem_a;
extern UIO_CONFIG_PARAMETER uio_iq_mem_b;
extern UIO_CONFIG_PARAMETER data_head_mem_a;
extern UIO_CONFIG_PARAMETER data_head_mem_b;
extern UIO_CONFIG_PARAMETER sensor_mem_0;
extern UIO_CONFIG_PARAMETER sensor_mem_1;
extern UIO_CONFIG_PARAMETER original_mem;
extern UIO_CONFIG_PARAMETER tvg_register_mem;
extern UIO_CONFIG_PARAMETER fpga_register_mem;
...
extern FPGA_DDR_FIRST fpga_ddr_frame_first_1;
extern FPGA_DDR_FIRST *ptr_fpga_frame_first_a;
extern FPGA_DDR_FIRST fpga_ddr_frame_first_2;
extern FPGA_DDR_FIRST *ptr_fpga_frame_first_b;
