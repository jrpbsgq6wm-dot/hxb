...
#define AD7124_ADC_CTRL_REG_DATA_STATUS    (1 << 10)    //ÿ�����ݼĴ���������֮��״̬�Ĵ������ݴ����ʹ���?
...
#define AD7124_ADC_CTRL_REG_MODE(x)        (((x) & 0xF) << 2)  
    /*
         ...
         0101 �ڲ�����?ʧ��)У׼  -�ڲ���·�Զ����ӵ�����ˣ�?RDY��У׼����ʱ��Ϊ�ߵ�ƽ����У׼���ʱ���ص͵�ƽ��У׼������ɺ�ADC���ڿ���ģʽ����õ�ʧ��ϵ����������ѡͨ����ʧ���Ĵ����С�ִ�����ƽУ׼ʱ��ֻ��ѡ��һ��ͨ����
         0110 �ڲ�������(����)У׼  -���ڸ�У׼�������������ѹ���Զ����ӵ�ѡ����ģ������?'RDY��У׼����ʱ��Ϊ�ߵ�ƽ����У׼���ʱ���ص͵�ƽ��У׼������ɺ�ADC���ڿ���ģʽ����õ�������ϵ����������ѡͨ��������Ĵ����С�ÿ�θ���һ��ͨ��������ʱ������Ҫִ��������У׼��ʹ�����������С��ִ��������У׼ʱ��ֻ��ѡ��һ��ͨ����? ��ȫ����ģʽ�£��޷�ִ���ڲ�������У׼��
         0111 ϵͳ����?ʧ��)У׼  -��ϵͳ���ƽ�������ӵ���ѡͨ����ͨ����������?
         1000 ϵͳ������(����)У׼  -��ϵͳ�������������ӵ���ѡͨ����������
    */
...
#define AD7124_ERR_REG_ADC_CAL_ERR        (1 << 18) //У׼��顣���У׼��������δ��ɣ��˱�־λ��?��ʾУ׼��������
#define AD7124_ERR_REG_ADC_CONV_ERR       (1 << 17) //��λ��ʾת������Ƿ���Ч�����ת�������з������󣬴˱�־λ��1��
#define AD7124_ERR_REG_ADC_SAT_ERR        (1 << 16) //ADC���ͱ�־�����ת�������е��������ͣ��˱�־λ��?��
...
#define AD7124_ERR_REG_DLDO_PSM_ERR       (1 << 9)  //����LDO�����������LDO��⵽���󣬴˱�־λ��?��
#define AD7124_ERR_REG_ALDO_PSM_ERR       (1 << 7)  //ģ��LDO�������ģ��LDO��ѹ��⵽���󣬴˱�־λ��?��
...
#define AD7124_ERREN_REG_LDO_CAP_CHK_TEST_EN   (1 << 21)    //ģ��/����LDOȥ����ݼ��Ĳ��ԡ���λ��?ʱ��ȥ�������LDO���ڲ��Ͽ���ǿ�Ʋ������ϡ��������û��Ϳ��Բ���ģ�������LDOȥ����ݼ�����õĵ�·
#define AD7124_ERREN_REG_LDO_CAP_CHK(x)        (((x) & 0x3) << 19) //ģ��/����LDOȥ����ݼ�顣
#define AD7124_ERREN_REG_ADC_CAL_ERR_EN        (1 << 18) //��λ��1ʱ��У׼���ϼ��ʹ�ܡ�?
#define AD7124_ERREN_REG_ADC_CONV_ERR_EN       (1 << 17) //��λ��1ʱ�����ת��������ת������ʱ��?
...
#define AD7124_ERREN_REG_REF_DET_ERR_EN        (1 << 11) //��λ��1ʱ���������ADCʹ�õ��ⲿ��׼��ѹԴ������ⲿ��׼��ѹԴ��·����ֵС��?.7 V�������־λ�ͻ���?��
...
#define AD7124_ERREN_REG_SPI_CRC_ERR_EN        (1 << 2)  //��λʹ�ܶ����ж�д������CRC���?
#define AD7124_ERREN_REG_MM_CRC_ERR_EN         (1 << 1)  //�����λ��?����ÿ��д��Ĵ���ʱ������Դ洢��ӳ��ִ��CRC���㡣

/* Channel Registers 0-15 bits - ͨ���Ĵ��� */
#define AD7124_CH_MAP_REG_CH_ENABLE    (1 << 15)    //ͨ��ʹ��λ����λ��1��ʹ������ͨ������ת�����С�Ĭ������£���ͨ��?��Enableλ��1��
...
extern float pa_v;
extern volatile float frist_pav;
...
uint32_t AD7124_READ_DATAREG(void);    //��ȡ���ݼĴ���
